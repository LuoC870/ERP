...
interface ILink<E> {	//设置泛型避免安全隐患
	...
	public boolean isEmpty() ; // 判断数据是否为空集合
...
class LinkImpl<E> implements ILink<E> {
	private class Node {	//保存节点的数据关系（私有内部类）
		private E data ;	//保存数据
		...
		//第三次调用：this = LinkImpl.root.next.netx ;
		public void addNode(Node newNode) {	//保存Node数据
	...
	public void add(E e) {
		...
		//数据本身不具备有关联性的，只有Node类有，实现关联数据则必须将数据封装在Node类中
